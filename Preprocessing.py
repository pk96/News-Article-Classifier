...
## STEP 1: PREPROCESSING: PART 4 - CONVERTING TEXT TO TF-IDF VECTOR REPRESENTATION
...
training2 = tfidf.fit_transform(X_train).todense()
test2 = tfidf.transform(X_test).todense()

with open('Pickles/training_dense.pickle', 'wb') as output:
    pickle.dump(training2, output)

with open('Pickles/test_dense.pickle', 'wb') as output:
    pickle.dump(test2, output)

with open('Pickles/X_train_pre.pickle', 'wb') as output:
    pickle.dump(X_train, output)
    
with open('Pickles/X_test_pre.pickle', 'wb') as output:
    pickle.dump(X_test, output)
    
with open('Pickles/y_train_pre.pickle', 'wb') as output:
    pickle.dump(y_train, output)

with open('Pickles/y_test_pre.pickle', 'wb') as output:
